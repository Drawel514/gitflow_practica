...
rut=r'BaseCrudColabTareas.xlsx'
...
while True:
  ...
  if accion<1 or accion>4:
    ...
    datosActualizados={'nombre':'','descripcion':'','estado':'','fecha inicio':'','fecha finalizacion':''}
    ...
    print('** nombre **\n')
    datosActualizados['nombre']=input('Indique el nombre de la tarea: ')
    print('\n** descripcion **')
